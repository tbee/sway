...
public class STableAIOTest extends TestBase {

    private STableAIO sTableAIO;
    ...
    public void happyStringBindingTest() throws Exception {
        ...
        construct(() -> {
            sTableAIO = new STableAIO<Bean1>() //
                    .name("table") //
                    .column(String.class).valueSupplier(Bean1::getName).valueConsumer(Bean1::setName).tableAIO()
                    .column(Integer.class).valueSupplier(d -> d.getDistance()).tableAIO();

            sTableAIO.data(data);

            return TestUtil.inJFrame(sTableAIO, focusMeComponent());
        });
        ...
        // THEN
        Assertions.assertEquals("abc", sTableAIO.sTable().getValueAt(0, 0));
    ...
    public void happyStringMonitorTest() throws Exception {
        ...
        // THEN
        Assertions.assertEquals("def", sTableAIO.sTable().getValueAt(0, 0));
        Assertions.assertEquals("Corine", bean2.getName());
    }
